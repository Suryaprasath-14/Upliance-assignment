...
import { v4 as uuidv4 } from "uuid";
import { 
  Box, Button, Input, FormLabel, FormControl, VStack, Heading, FormErrorMessage, 
  useToast, useBreakpointValue 
} from "@chakra-ui/react";
...
function UserDataForm() {
  ...
  const toastStyle = useBreakpointValue({
    base: { fontSize: "12px", padding: "8px", maxWidth: "80%" }, // Smaller on mobile
    md: { fontSize: "16px", padding: "12px", maxWidth: "50%" } // Normal on desktop
  });
  ...
  const handleSubmit = (e) => {
    ...
    toast({
      title: "Data Saved!",
      description: "Check your info in the Dashboard or Text Editor.",
      status: "success",
      duration: 4000, 
      isClosable: true,
      position: "top", 
      containerStyle: toastStyle, //Responsive size
    });
  };
